...
## Purpose
Generate AWR-style deep performance diagnostics for **aws_rds** with default **30-minute snapshots** and **7-day retention**.
...
AWS RDS MySQL inherits the full MySQL deep collector (25 sections) and renders the same structured AWR-style report.
